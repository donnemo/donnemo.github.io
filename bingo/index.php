...
<meta name="description" content="Conference call interactive bingo cards">
...
<meta property="og:title" content="Conference Call Bingo" />
<meta property="og:description" content="Make conference calls great again with Conference Call Bingo!" />
<meta property="og:url" content="http://geekymuse.com/bingo/" />
<meta property="og:site_name" content="Geeky Muse" />
<meta property="og:image" content="http://geekymuse.com/bingo/roy.jpg" />
<!-- CSS -->
<link rel="stylesheet" type="text/css" href="bingo.css">
<!-- Icons -->
<link rel="apple-touch-icon" sizes="180x180" href="/bingo/icons/apple-touch-icon.png">
<link rel="icon" type="image/png" href="/bingo/icons/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="/bingo/icons/favicon-16x16.png" sizes="16x16">
<link rel="manifest" href="/bingo/icons/manifest.json">
<link rel="mask-icon" href="/bingo/icons/safari-pinned-tab.svg" color="#f96672">
<link rel="shortcut icon" href="/bingo/icons/favicon.ico">
<!-- jQuery -->
...
<div class="container">
   ...
   <section id="winMsg"> <a href="https://twitter.com/share" class="twitter-share-button" data-text="B I N G O !" data-url="http://www.geekymuse.com/bingo/" data-via="donnemo" data-hashtags="ccbingo #ConferenceCallBingo #Bingo" data-show-count="false">Bingo!</a> </section>
   ...
   <section>
      ...
      <article>
         <p>This is your personal "card" of 24 unique randomly selected phrases (or occurences) that might be spoken by a participant. Just tap the squares for anything you hear to toggle between checked and unchecked. When you get a winning row, column or diagonal, a confirmation box will appear for you to check off each square again. If you confirm your winning sequence of boxes, you win. If not, you can tap "Keep trying" to continue playing. Reload the page for a new random batch of words - but be careful not to reload the page accidentally or you will lose your progress.</p>
      </article>
   </section>
   <section id="tweet"> <a href="https://twitter.com/share" class="twitter-share-button" data-text="Make conference calls fun again with Bingo" data-url="http://www.geekymuse.com/bingo/" data-via="donnemo" data-hashtags="ccbingo #ConferenceCallBingo #Bingo" data-show-count="false">Tweet</a> </section>
   <footer>
      <p>🍔 <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">CC BY-NC-SA 4.0</a> 2017 <a href="https://twitter.com/burblebeep" target="_blank">George Fox</a> and <a href="https://twitter.com/donnemo" target="_blank">Andrew Paulson</a>🇺🇸</p>
   </footer>
</div>
<script>
var winSeq = false;
...
function hasWon() {
	...
	winSeq = true;
	$( "#confirmation" ).toggle( "slow" );
/* 	$( "#winMsg" ).empty(); */ $( "#winMsg" ).prepend( "<h1>B I N G O!</h1>");
	$( "#winMsg" ).toggle( "slow" );
	$( "body" ).addClass( "win" );
};
...
// Used like so
var arr = ["Hi, who just joined?","I'm sorry, you cut out there.","No, it's still loading.","Unintelligible or fades out","Can you repeat that?","Next slide, please.","Uh, ___, you're still sharing.","I'll have to get back to you later.","I think there's a lag.","Can we/let's take this offline.","Loud echo or feedback","Hello? Hello?","Sorry, I was having connection issues.","Can everyone go on mute?","Sound of someone typing (possibly with a hammer)","Overtalker: Sorry, go ahead.","Child or animal noises","Hi, can you hear me?","Sorry I'm late (lame excuse optional)","Can everyone see my screen?","I have a hard stop at...","___, are you there?","I'm sorry, I was on mute.","Can you email that to everyone?","Hey guys, I have to jump on another call.","Awkward pause","Toilet flush","Someone drops","Sound of someone chewing or eating","This conference call has not yet started","Organizer is last to dial in"];
arr = shuffle(arr);
console.log(arr);
